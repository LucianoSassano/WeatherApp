          ...
          <div className="container-fluid" id="navbarSupportedContent">
            <div>
              <ul className="nav nav-tabs mr-auto">
                <li className="nav-item " aria-label="Home button">
                  <a
                    className={props.homeView === true ? "nav-link active" : "nav-link "}
                    href="./"
                  >
                    Home
                  </a>
                ...
                <li className="nav-item" aria-label="Favorites button">
                  <a
                    className={props.favoritesView === true ? "nav-link active" : "nav-link "}
                    href="./favorites"
                  >
                    Favorites
                  </a>
            ...
            {props.favoritesView ? (
              ...
              <div className="search-form">
                <div
                  id="customSwitchContainer1"
                  className="custom-control custom-switch custom-switch-xl"
                >
                  <input
